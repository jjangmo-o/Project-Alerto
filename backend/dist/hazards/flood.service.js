...
exports.FloodService = void 0;
const common_1 = require("@nestjs/common");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const turf = __importStar(require("@turf/turf"));
let FloodService = class FloodService {
    floodGeoJSON = null;
    constructor() {
        this.loadFloodData();
    }
    ...
    calculateRouteFloodRisk(coordinates) {
        let totalRisk = 0;
...
exports.FloodService = FloodService;
exports.FloodService = FloodService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], FloodService);
//# sourceMappingURL=flood.service.js.map